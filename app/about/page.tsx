    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-amber-900 mb-4">About MEEHOWW</h1>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-amber-900 mb-6 text-center">Our Core Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card key={title} className="p-6 border-orange-100 text-center">
        ...
        {/* Statistics */}
        <section className="bg-white rounded-lg p-8 border border-orange-100 mb-12">
          <h2 className="text-2xl font-bold text-amber-900 mb-6 text-center">By The Numbers</h2>
        ...
        {/* Team Section */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-amber-900 mb-6 text-center">Our Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Emily Rodriguez', role: 'Veterinary Director' },
            ].map((member) => (
              <Card key={member.name} className="p-6 border-orange-100 text-center">
        ...
        {/* Contact CTA */}
        <section className="bg-orange-50 rounded-lg p-8 border-2 border-orange-200 text-center">
          ...
          <a href="/contact" className="inline-block px-8 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition">
            Contact Us
          </a>
        </section>
      </main>
