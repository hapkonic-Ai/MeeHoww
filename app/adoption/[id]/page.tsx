...
import { Heart, MapPin, Calendar, Home, PawPrint } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-amber-50/50 to-white">
        ...
        <main className="max-w-7xl mx-auto px-4 py-12">
          <p className="text-amber-700/60">Pet not found</p>
        </main>
        <Footer />
      </div>
    )
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12 w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <Card className="overflow-hidden mb-6 border-amber-100">
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h1 className="text-4xl font-bold text-amber-950 mb-2">{pet.name}</h1>
                    <p className="text-xl text-amber-800/70">{pet.breed}</p>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8 py-6 border-t border-b border-amber-100">
                  <div>
                    <p className="text-sm text-amber-700/60">Age</p>
                    <p className="font-semibold text-amber-950">{pet.age}</p>
                  </div>
                  <div>
                    <p className="text-sm text-amber-700/60">Gender</p>
                    <p className="font-semibold text-amber-950">{pet.gender}</p>
                  </div>
                  <div>
                    <p className="text-sm text-amber-700/60">Adoption Fee</p>
                ...
                <div className="mb-6">
                  <h2 className="text-xl font-semibold text-amber-950 mb-3">About {pet.name}</h2>
                  <p className="text-amber-800/70 mb-4">{pet.description}</p>
                </div>

                <div className="mb-6 bg-orange-50 p-6 rounded-lg border border-orange-200">
                  <h3 className="font-semibold text-amber-950 mb-2">{pet.name}'s Story</h3>
                  <p className="text-amber-800/70">{pet.story}</p>
                </div>

                <div className="flex items-center gap-2 text-amber-800/70 mb-6">
                  <MapPin className="w-5 h-5 text-amber-600/50" />
                ...
                {session ? (
                  <Button
                    ...
                    size="lg"
                    className="w-full bg-amber-800 hover:bg-amber-700 flex items-center justify-center gap-2"
                  >
                    <Heart className="w-5 h-5" />
          ...
          <div>
            {showForm && (
              <Card className="p-6 border-amber-100 sticky top-4">
                <h2 className="text-xl font-bold text-amber-950 mb-6">Adoption Application</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-amber-800/70">
                      <input
                        type="checkbox"
                  ...
                  <Button
                    ...
                    className="w-full bg-amber-800 hover:bg-amber-700 text-sm"
                  >
