  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {SERVICES.map((service, index) => (
                <Card key={index} className="p-6 border-orange-100 hover:shadow-lg transition">
        ...
        {/* Contact Section */}
        <section className="max-w-7xl mx-auto px-4 py-16">
          <Card className="p-8 md:p-12 border-orange-100 bg-gradient-to-br from-orange-50 to-amber-50">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700">123 Pet Care Avenue, Veterinary City, VC 12345</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-amber-900 mb-1">Phone</h3>
                    <p className="text-gray-700">
                      <strong>Emergency:</strong> 1-800-PET-HELP (1-800-738-4357)
                    </p>
                    <p className="text-gray-700">
                      <strong>General:</strong> (555) 123-4567
                    </p>
                  </div>
                  <div>
              ...
              <div>
                <h2 className="text-2xl font-bold text-amber-900 mb-6">Emergency Hotline</h2>
                <div className="bg-white p-6 rounded-lg border-2 border-red-500">
                  ...
                  <div className="text-4xl font-bold text-red-600 mb-6">1-800-PET-HELP</div>
                  <Button
                    size="lg"
            ...
            <div className="space-y-6">
              <Card className="p-6 border-orange-100">
                ...
                <p className="text-gray-700">
                  ...
                  Appointment" or by calling us at (555) 123-4567. We typically have availability
              ...
              <Card className="p-6 border-orange-100">
                ...
                <p className="text-gray-700">
                  ...
                  1-800-PET-HELP. Our emergency team will assess your pet and provide immediate
                  care. You can also submit an online emergency request through the app.
                </p>
              </Card>

              <Card className="p-6 border-orange-100">
                <h3 className="text-lg font-semibold text-amber-900 mb-2">Do you accept insurance?</h3>
                <p className="text-gray-700">
